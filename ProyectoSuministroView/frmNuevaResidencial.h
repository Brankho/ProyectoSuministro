...
namespace ProyectoSuministroView {
	...
	/// <summary>
	/// Resumen de frmNuevaResidencial
	/// </summary>
	public ref class frmNuevaResidencial : public System::Windows::Forms::Form
	{
	public:
		frmNuevaResidencial(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(139, 43);
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevaResidencial::button1_Click);
			// 
			// textBox3
			// 
			...
			this->comboBox2->Items->AddRange(gcnew cli::array< System::Object^  >(3) { L"DIAMANTE", L"VIVAMAS", L"CASAMAS" });
			...
			this->comboBox1->Location = System::Drawing::Point(274, 117);
			...
			this->label1->Location = System::Drawing::Point(53, 120);
			...
			this->Name = L"frmNuevaResidencial";
			this->Text = L"frmNuevaResidencial";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		objResidencialController->agregarNuevaResidencial(constructora, sectorUrbano, cantBloques, cantDepartamentos, cantTanques);
